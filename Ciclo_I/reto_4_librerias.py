...
# print(generar_correo(nombre="Sara Carolina", apellido="Gómez, Fernández", identificacion=str(1785292)))


def generar_correo(nombre: str, apellido: str, identificacion: str) -> str:
    # nombre = ajuste_de_texto(nombre)
    # tapellido = ajuste_de_texto(apellido)
    if nombre.find(" ") > 0:
        correo = nombre[0] + nombre[nombre.find(" ") + 1] + "." + apellido[0:apellido.index(",")]
    else:
        correo = nombre[0] + apellido[0] + "." + apellido[apellido.index(" ") + 1:-1]
...
# Expected return: ({'Arquitectura': 3.84, 'Diseño': 3.37, 'Historia del Arte': 3.66, 'Ingenieria': 3.88, 'Medicina':
