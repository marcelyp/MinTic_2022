...
public class SimuladorBancarioTest
{
    ...
    private void setupEscenario10()
    {
    	setupEscenario2();
    	try {
        	this.cuenta.invertirCDT(500000, "0.02");
		} catch (Exception e) {
    ...
    public void testPunto1()
    {
    	setupEscenario10();
    	cuenta.avanzarMesSimulacion();
    	this.cuenta.cerrarCDT();
    	int respuesta = 1902800;
    	assertEquals( "ERROR EN EL PUNTO 1", respuesta, ( int )cuenta.calcularSaldoTotal(), 5);    	
    }
    ...
    public void testPunto2a()
    {
    	...
    	int valor = ( int )cuenta.calcularSaldoTotal();
    	assertEquals( "El saldo de la cuenta corriente no es el esperado", respuesta, valor, 5);    	
    }
    
    @Test
    public void test_imaster_1()
    {
    	int consecutivo = -1;
        try
        {
